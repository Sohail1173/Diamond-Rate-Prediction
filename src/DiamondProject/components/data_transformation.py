...
from src.DiamondProject.utils.util import save_object
...
class DataTransformation:
    ...
    def get_data_transformation(self):
        try:
            ...
            logging.info("Exception occurred in the intiate_datatransformation")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Applying preprocessing objecct on training and testing datasets")
